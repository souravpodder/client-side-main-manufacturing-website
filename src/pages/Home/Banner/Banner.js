...
const Banner = () => {
  return (
    ...
    <div className='hero hero-banner bg-no-repeat bg-cover bg-blue-500 bg-opacity-100 h-[100vh] lg-[70vh]'>
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className='mr-10 px-10'>
          <h1 className="text-2xl lg:text-5xl font-bold text-secondary">Get All the Neccessary camera parts in one place</h1>
